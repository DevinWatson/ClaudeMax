...
- Identify the consumer and provider sides, the contract approach (Pact-style consumer/provider
  tests against the HTTP surface), the broker/publication mechanism, and the environment before
  writing.
...
- **Write the Julia** using [[julia-idioms]]: idiomatic consumer and provider tests with correct
