...
- Identify the consumer and provider sides, the contract tool (Pact via pact-cpp), the
...
- **Write the C++** using [[cpp-idioms]]: idiomatic consumer and provider tests with correct JSON
  serialization, matchers, and resource handling.
