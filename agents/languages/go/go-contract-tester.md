...
- Identify the consumer and provider sides, the contract tool (Pact-Go), the broker/publication
...
- **Write the Go** using [[go-idioms]]: idiomatic consumer and provider tests with correct
  `encoding/json` (de)serialization and matchers.
