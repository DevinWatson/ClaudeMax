...
- Identify the consumer and provider sides, the contract tool (Pact for Elixir), the
...
- **Write the Elixir** using [[elixir-idioms]]: idiomatic consumer and provider tests with correct
