...
- Identify the consumer and provider sides, the contract tool (Pact, generated-contract checks),
  the broker/publication mechanism, and the SwiftPM package before writing.
...
- **Write the Swift** using [[swift-idioms]]: idiomatic consumer and provider tests with correct
  `Codable` serialization and matchers.
...
- Defer gRPC/protobuf wire compatibility to swift-proto-steward.
