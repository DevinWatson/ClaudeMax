...
- Identify the consumer and provider sides, the contract approach (Pact-style pacts, recorded
  fixtures, or a shared schema), the broker/publication mechanism, and the Dune build before
  writing.
...
- **Write the OCaml** using [[ocaml-idioms]]: idiomatic consumer and provider tests with correct
  JSON (de)serialization and matchers.
- **Fit the codebase** via [[match-project-conventions]]: match the project's contract approach,
