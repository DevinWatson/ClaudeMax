...
- Identify the consumer and provider sides, the contract tool (Pact-PHP), the broker/publication
...
- **Write the PHP** using [[php-idioms]]: idiomatic consumer and provider tests with correct
  serialization and matchers.
